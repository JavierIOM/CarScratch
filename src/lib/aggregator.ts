  ...
  try {
    ...
    if (scrapedData) {
      extras = {
        ...
        fuelEconomyMpg: sanitizeScrapedString(scrapedData.fuelEconomyMpg, 20),
        fuelEconomyUrban: sanitizeScrapedString(scrapedData.fuelEconomyUrban, 20),
        fuelEconomyExtraUrban: sanitizeScrapedString(scrapedData.fuelEconomyExtraUrban, 20),
        costWhenNew: sanitizePrice(scrapedData.costWhenNew),
